...
&= [\mathbf{\omega}]_\times\, \mathbf{R}\, \mathbf{J}_0\, \mathbf{R}^\mathrm{T} + \mathbf{R}\, \mathbf{J}_0\, \left( -\mathbf{R}^\mathrm{T} [\mathbf{\omega}]_\times \right) \\
&= [\mathbf{\omega}]_\times\, \mathbf{J} - \mathbf{J} [\mathbf{\omega}]_\times
\end{align*}
$$

其中$$[\mathbf{\omega}]_\times$$是角速度反对称矩阵。
